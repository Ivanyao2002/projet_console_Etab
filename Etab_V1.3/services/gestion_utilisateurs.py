...
class ServicesUtilisateur:
    ...
    def gestionUtilisateurs():
        Menu.accueil("GESTION DES UTILISATEURS")
        while True:
            Menu.afficherSousMenuUtil()
            try:
            ...
            match choix:
                case 1:
                    ServicesUtilisateur.ajouterUtilisateur()
                case 2:
                    ServicesUtilisateur.supprimerUtilisateur()
                case 3:
                    ServicesUtilisateur.modifierUtilisateur()
                case 4:
                    ServicesUtilisateur.listerUtilisateurs()               
                case 5:
                    break             
                case 0:
                    return                   
